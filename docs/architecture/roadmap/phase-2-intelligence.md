...
> сверх time, текущая через фич-локальность.
> ⚠️ **Уточнение (2026-08-08):** «по `FeatureLocality`» здесь — обоснование выбора фичи, а не вызов. Сам класс
> **не подключён**: ни `MlTrainer`, ни один шаблон его не спрашивают, поэтому «жёсткая стена между видами зон»
> сейчас описана, но ничем не обеспечена. Подключение — вместе с зональными сенсорами ниже.
> **Остаток:** произвольные **зональные** admissible-сенсоры
