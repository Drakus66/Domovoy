...
public class CapabilityDevicesController : ProxyController
{
    public CapabilityDevicesController(IHttpClientFactory httpClientFactory) : base(httpClientFactory) { }
    ...
    public Task<IActionResult> Get(string id, CancellationToken ct)
        => Forward($"api/capability-devices/{Uri.EscapeDataString(id)}", ct);
    ...
    public Task<IActionResult> AssignZone(string id, CancellationToken ct)
        => Forward($"api/capability-devices/{Uri.EscapeDataString(id)}/zone", ct);
    ...
    public Task<IActionResult> SetAlias(string id, CancellationToken ct)
        => Forward($"api/capability-devices/{Uri.EscapeDataString(id)}/alias", ct);
    ...
    public Task<IActionResult> SetArchetype(string id, CancellationToken ct)
        => Forward($"api/capability-devices/{Uri.EscapeDataString(id)}/archetype", ct);
    ...
    public Task<IActionResult> SetEnergyProfile(string id, CancellationToken ct)
        => Forward($"api/capability-devices/{Uri.EscapeDataString(id)}/energy-profile", ct);
    ...
    public Task<IActionResult> SetLoadShedding(string id, CancellationToken ct)
        => Forward($"api/capability-devices/{Uri.EscapeDataString(id)}/load-shedding", ct);
